...
<div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form action="{{ url('/adminlogin')}}" method="post" class="my-10">
            @csrf
            <div class="flex flex-col space-y-5">
                ...
                <p class="text-center">User? <a href="/login" class="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>login </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg></span></a></p>
            </div>
        </form>
