...
<!--WELCOME-->
<div class="w-screen h-[216px] px-[170px] py-[60px] bg-black bg-opacity-60 justify-center items-center gap-[60px] inline-flex " style="background-image: url('img/section.jpg'); background-size: cover; background-position: center; background-blur: 15px; ">
...
<div class="w-screen h-[228px] px-[170px] py-[60px] bg-white justify-center items-center gap-10 inline-flex">
    <div class="w-[100px] h-[100px] relative bg-zinc-300 bg-opacity-50 rounded-[50px]" style="background-image: url('img/about.jpg'); background-size: cover; background-position: center;" ></div> 
    <div class="grow shrink basis-0 flex-col justify-start items-center gap-3 inline-flex">
        <div class="self-stretch text-black text-2xl font-bold font-['Roboto'] leading-loose">John Doe</div>
