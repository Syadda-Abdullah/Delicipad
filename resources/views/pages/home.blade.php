...
<!--WELCOME-->
<div class="w-screen h-[520px] px-[170px] py-[60px] bg-black bg-opacity-60 justify-center items-center gap-[60px] flex">
    <div class="grow shrink basis-0 flex-col justify-start items-start gap-6 inline-flex">
        <div class="self-stretch"><span style="text-white text-[40px] font-bold font-['Roboto'] leading-[48px]">Welcome to</span><span style="text-white text-[40px] font-bold font-['Roboto'] leading-[48px]"> Delicipad</span><span style="text-white text-[40px] font-bold font-['Roboto'] leading-[48px]">!</span></div>
        ...
        <div class="justify-start items-start gap-3 inline-flex">
            <div class="w-40 p-3 rounded-lg border border-white flex-col justify-center items-center inline-flex">
                <div class="text-white text-base font-medium font-['Roboto'] leading-normal">View Menu</div>
            </div>
            <div class="w-40 p-3 bg-black rounded-lg flex-col justify-center items-center inline-flex">
                <div class="text-white text-base font-medium font-['Roboto'] leading-normal">Order Now</div>
            </div>
        </div>
    </div>
    <div class="grow shrink basis-0 h-[400px] py-1 justify-start items-start flex">
        <div class="w-[520px] h-[392px] relative bg-zinc-300 bg-opacity-50 rounded-md" ></div>
    </div>
</div>
        ...
        <div class="self-stretch py-5 justify-center items-center gap-10 inline-flex">
            <div class="grow shrink basis-0 rounded-md border border-black border-opacity-10 flex-col justify-start items-center inline-flex">
                <div class="self-stretch h-[340px] justify-start items-start inline-flex">
                    <div class="w-[340px] h-[340px] relative bg-zinc-300 bg-opacity-50">
                        <div class="w-[308px] h-4 left-[16px] top-[162px] absolute text-center text-black text-xs font-normal font-['Roboto'] leading-none">Beef Rendang</div>
                ...
                <div class="self-stretch h-[108px] p-3 flex-col justify-start items-start gap-1 flex">
                    ...
                    <div class="self-stretch text-black text-xl font-medium font-['Roboto'] leading-7">$15</div>
            ...
            <div class="grow shrink basis-0 rounded-md border border-black border-opacity-10 flex-col justify-start items-center inline-flex">
                <div class="self-stretch h-[340px] justify-start items-start inline-flex">
                    <div class="w-[340px] h-[340px] relative bg-zinc-300 bg-opacity-50">
                        <div class="w-[308px] h-4 left-[16px] top-[162px] absolute text-center text-black text-xs font-normal font-['Roboto'] leading-none">Nasi Padang</div>
                        <div class="px-2 py-1 left-0 top-0 absolute bg-black bg-opacity-5 rounded-tl-md rounded-br-md flex-col justify-center items-center inline-flex">
                ...
                <div class="self-stretch h-[108px] p-3 flex-col justify-start items-start gap-1 flex">
                    ...
                    <div class="self-stretch text-black text-xl font-medium font-['Roboto'] leading-7">$12</div>
                </div>
            </div>
            <div class="grow shrink basis-0 rounded-md border border-black border-opacity-10 flex-col justify-start items-center inline-flex">
                <div class="self-stretch h-[340px] justify-start items-start inline-flex">
                    <div class="w-[340px] h-[340px] relative bg-zinc-300 bg-opacity-50">
                        <div class="w-[308px] h-4 left-[16px] top-[162px] absolute text-center text-black text-xs font-normal font-['Roboto'] leading-none">Gado-Gado</div>
                        <div class="px-2 py-1 left-0 top-0 absolute bg-black bg-opacity-5 rounded-tl-md rounded-br-md flex-col justify-center items-center inline-flex">
                ...
                <div class="self-stretch h-[108px] p-3 flex-col justify-start items-start gap-1 flex">
                    ...
                    <div class="self-stretch text-black text-xl font-medium font-['Roboto'] leading-7">$10</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="self-stretch justify-start items-center gap-10 inline-flex">
            <div class="grow shrink basis-0 h-[184px] p-4 rounded-md border border-black border-opacity-10 justify-center items-start gap-4 flex">
                ...
                <div class="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                    ...
                    <div class="self-stretch h-12 text-black text-base font-normal font-['Roboto'] leading-normal">Padang Restaurant has been serving authentic Padang cuisine for over three decades. Our recipes are passed down through generations, ensuring an unparalleled taste experience.</div>
...
<div class="w-screen h-[648px] px-[170px] py-[60px] justify-center items-center gap-[60px] inline-flex">
    <div class="grow shrink basis-0 flex-col justify-start items-center gap-6 inline-flex">
        ...
        <div class="flex-col justify-start items-start gap-3 flex">
            <div class="h-12 p-3 bg-black rounded-lg flex-col justify-center items-center flex">
                <div class="text-white text-base font-medium font-['Roboto'] leading-normal">View Full Menu</div>
            </div>
        </div>
