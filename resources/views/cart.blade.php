...
<div class=''>
  <div class='container mt-10 px-8 mx-auto max-w-xl rounded-lg shadow-lg p-10 bg-slate-100 min-h-60'>
...
<div class='flex items-center justify-center space-x-8 w-screen min-h-screen -mt-20'>
  <div class=''>
      <div class="container mt-5 px-8 mx-auto max-w-96 mb-10 rounded-lg shadow-lg p-10 bg-slate-100 min-h-60">
  ...
  <div class='flex-[0.3]'>
      <div class="container mt-10 px-8 mx-auto max-w-96 mb-10 rounded-lg shadow-lg p-10 bg-slate-100 min-h-60 " >
          <div class="mb-4">
            <div class="relative h-10 w-full min-w-[200px]">
              <input
          ...
          <div class= 'flex mt-10 justify-center l'>
            <button class="rounded-lg relative h-12 w-40 overflow-hidden border border-indigo-600 text-indigo-600 shadow-2xl transition-all duration-200 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-0 before:w-0 before:rounded-sm before:bg-indigo-600 before:duration-300 before:ease-out hover:text-white hover:shadow-indigo-600 hover:before:h-40 hover:before:w-40 hover:before:opacity-80">
